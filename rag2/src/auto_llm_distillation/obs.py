...
NLU_API_URL = 'http://172.24.169.93:16073/ligpt_with_api/search'
...
# 调用obs
df_obs = get_obs_df(df, length_limit=3000, output_path='./obs_300.csv') #length_limit 表示obs最大长度，超长pop
print (df_obs)