...
run_python_script "extension" "single_True_rag_True" "livis_extension_single_True_rag_True_dpo_${start_date}_${end_date}_送标" "livsi_extension_single_True_rag_True_sft_${start_date}_${end_date}"
...
# Run for /raw/single_True_rag_True/
run_python_script "raw" "single_True_rag_True" "car_raw_single_True_rag_True_dpo_${start_date}_${end_date}_送标" "livis_raw_single_True_rag_True_sft_${start_date}_${end_date}"

# Run for /extension/single_True_rag_True/
run_python_script "extension" "single_True_rag_True" "car_extension_single_True_rag_True_dpo_${start_date}_${end_date}_送标" "livsi_extension_single_True_rag_True_sft_${start_date}_${end_date}"
