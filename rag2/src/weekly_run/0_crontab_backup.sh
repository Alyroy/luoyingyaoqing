...
0 1 * * * bash /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/run_crontab_filter_log_single_rag.sh >> /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/crontab_logs/filter_log_single_rag.log 2>&1

# 每天8点 统计 T-3 自动化蒸馏筛选数据数量
0 8 * * * bash /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/run_crontab_report.sh >> /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/crontab_logs/report.log 2>&1
...
0 20 * * * bash /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/run_crontab_car_distillation_log_raw_single_rag.sh >> /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/crontab_logs/car_distillation_log_raw_single_rag.log 2>&1

# 每天晚上8点 蒸馏 T-2 线上日志泛化query(car)
0 20 * * * bash /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/run_crontab_car_distillation_log_extension_single_rag.sh >> /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/crontab_logs/car_distillation_log_extension_single_rag.log 2>&1

# 每天早晨2点 自动化筛选 T-3 蒸馏数据 
0 2 * * * bash /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/run_crontab_car_filter_log_single_rag.sh >> /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/weekly_run/crontab_logs/car_filter_log_single_rag.log 2>&1
