...
import sys, os, re
import shutil
source_file = "/mnt/pfs-guan-ssai/nlu/gongwuxuan/public/vllm-qwen-swa/qwen2swa-4096-vllm-0-6-5.py"
target_file = "/opt/conda/lib/python3.10/site-packages/vllm/model_executor/models/qwen2.py"
