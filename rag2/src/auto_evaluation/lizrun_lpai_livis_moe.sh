...
lizrun lpai start -c "bash /lpai/volumes/ssai-nlu-bd/nlu/app/gongwuxuan/_init_server_.sh; bash /mnt/pfs-guan-ssai/nlu/renhuimin/rag_tool/src/auto_evaluation/livis_moe_run_inference_api_mp.sh" \
    -j eval-time-future \
    -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.1.0-multinode-flashattn-2.3.2-fsdp  \
    -p app-bd  \
    -n 1 \
