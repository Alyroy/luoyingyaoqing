...
prompt_path=/mnt/pfs-guan-ssai/nlu/chihuixuan/rag_tool/rag2/src/auto_evaluation/prompts/chx/common-truthful_v3.txt
...
# 模型的temperature值
temperature=0
input_text_type='function_call' # 'default' 或 'function_call'
