...
# 全局参数设置
CURRENT_DIR=/mnt/pfs-guan-ssai/nlu/chenjun18/rag_tool/rag2/src/auto_evaluation/
cd $CURRENT_DIR
...
declare -a QUEUE_NAME_LIST=("security")  # 根据需要添加更多队列名
declare -a JOB_NAME_LIST=("qwen-dpo-r4")  # 根据需要添加更多任务名

# 训练模型转格式脚本路径
HF_MODEL_CKPT_DIR_SUFFIX=""

# 输入与输出目录设定
INPUT_DIR='/eval_data/safety_0115'
OUTPUT_DIR="/eval_results/"
EVAL_COL=model_13b_input
