...
def cal_auth_rel(eval_folder,job_name,eval_model_name='qwen25-72b',auth_metric='authenticity_test_api_eval',rel_metric='relevance_test_api_eval'):
    input_files = ['手机APP_泛化集_2024-08-23T21_34_46.379.csv_fc.csv','APP同分布开发集16b评估-0821.csv_fc.csv']
    ...
    for file in input_files:
        ...
        auth_wrong_num = len(df_auth[df_auth['qwen_eval_response'].str.contains('wrong data')])
        df_auth = df_auth[~df_auth['qwen_eval_response'].str.contains('wrong data')]
        ...
        rel_wrong_num = len(df_rel[df_rel['qwen_eval_response'].str.contains('wrong data')])
        df_rel = df_rel[~df_rel['qwen_eval_response'].str.contains('wrong data')]
    ...
    result_items = ['整体真实性得分', '整体相关性得分', '手机APP_泛化集_2024-08-23T21_34_46.379.csv_fc.csv-真实性','手机APP_泛化集_2024-08-23T21_34_46.379.csv_fc.csv-相关性','APP同分布开发集16b评估-0821.csv_fc.csv-真实性','APP同分布开发集16b评估-0821.csv_fc.csv-相关性','手机APP_泛化集_2024-08-23T21_34_46.379.csv_fc.csv-真实性-wrong-num',
                    '手机APP_泛化集_2024-08-23T21_34_46.379.csv_fc.csv-相关性-wrong-num','APP同分布开发集16b评估-0821.csv_fc.csv-真实性-wrong-num',
                    'APP同分布开发集16b评估-0821.csv_fc.csv-相关性-wrong-num']
    result_value = []
