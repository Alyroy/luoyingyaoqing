...
# 全局参数设置
CURRENT_DIR=/mnt/pfs-guan-ssai/nlu/gongwuxuan/code/rag_tool/rag2/src/auto_evaluation
cd $CURRENT_DIR

# 配置模型参数
declare -a MODEL_CKPT_DIR_LIST=(
    "/mnt/pfs-guan-ssai/nlu/xjn/project/li-safe-rlhf-new/lisft/output/mgpt25d_s2_1209_livis-dpo-1216_1215-seed42-0/global_step2922/functioncall_hf_model"
)

declare -a QUEUE_NAME_LIST=("wq-app")
declare -a JOB_NAME_LIST=("qwen25-swa-dpo-253d-eval")
USER_NAME=gongwuxuan

# 输入与输出目录设定
INPUT_DIR=${CURRENT_DIR}'/eval_data/livis_query_fc_1114/' # query扩展形式
OUTPUT_DIR=${CURRENT_DIR}'/eval_results/2024-12/'
