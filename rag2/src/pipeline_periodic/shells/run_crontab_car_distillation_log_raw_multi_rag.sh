...
JOB_NAME="distillate_raw_log_multi_rag_car"
...
ExecuteJobFunction() {
    ...
    # 对日志数据回复糟糕的部分进行蒸馏
    python get_raw_log_distillation.py --no_is_single_flag --is_rag_flag --model_name 'gpt4o' --model_url ${model_url} --base_output_path ${base_output_path} --prompt_path ${prompt_path} --input_file ${input_file}
