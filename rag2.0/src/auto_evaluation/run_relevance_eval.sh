...
metric=relevance
prompt_path=/mnt/pfs-guan-ssai/nlu/data/renhuimin/pro_rag/conf/evaluation_prompts/relevance-prompts-resp.txt
...
# 输出路径
output_dir=/mnt/pfs-guan-ssai/nlu/data/renhuimin/pro_rag/data/eval_data/v20240717/相关性打分_gpt4_0607/
...
# 输出路径
output_dir=/mnt/pfs-guan-ssai/nlu/data/renhuimin/pro_rag/data/eval_data/v20240717/相关性打分_gpt4_0717_base/
