...
# 输入路径，可以是目录也可以是文件
input_dir=/mnt/pfs-guan-ssai/nlu/gongwuxuan/code/personal_dev_tool/myData/output/moe-obsprocess-300-0813/obs-泛化集随机挑选-300-process-shuflle_and_raw.csv.moe-obsprocess-0813-reorder.csv
# 输出路径
output_dir=/mnt/pfs-guan-ssai/nlu/gongwuxuan/code/personal_dev_tool/myData/output/moe-obsprocess-300-0813/真实性打分
