...
SERVER_PORT=8000
BROAD_CAST_FILE=/lpai/volumes/ssai-nlu-bd/nlu/app/gongwuxuan/pubilc/Llama3_70B_running_url.log

MODEL=/lpai/volumes/ssai-nlu-bd/lizr/models/Llama3_70B_instruct_chinese
...
echo "llama3 70b api服务启动地址 http://${SERVER_NAME}:${SERVER_PORT}" | tee ${BROAD_CAST_FILE}
