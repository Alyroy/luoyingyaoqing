...
lizrunv2 lpai start -c "bash -c /mnt/pfs-guan-ssai/nlu/gongwuxuan/code/rag_tool/rag2.0/src/tool_llm_response/model_deployment/gwx-lpai_vllm_qwen2_72b_api.sh" \
