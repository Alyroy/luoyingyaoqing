...
lizrunv2 lpai start -c "bash -c /lpai/volumes/ssai-nlu-bd/nlu/app/gongwuxuan/code/rag_tool/rag2.0/src/tool_llm_response/model_deployment/lpai_vllm_qwen2_72b_api.sh" \
